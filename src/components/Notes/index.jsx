			...
			<article className='note'>
				...
				<div className='note__card'>
					...
					<p className='note__card-text'>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos illum dolorum quas
						aspernatur ab asperiores aliquam reprehenderit tempora, odit dolorem ducimus non ullam totam
						cumque.
					</p>
					<hr />
